    ...
    model(0)
{
    ...
    // normal utopiacoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying utopiacoin address(es)
    ui->payTo_is->setFont(GUIUtil::utopiacoinAddressFont());
...
void SendCoinsEntry::clear()
{
    ...
    // update the display unit, to not use the default ("UCN")
    updateDisplayUnit();
}
