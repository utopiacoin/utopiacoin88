...
UtopiacoinGUI::UtopiacoinGUI(const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    clientModel(0),
    walletFrame(0),
    ...
    spinnerFrame(0)
{
    ...
    QString windowTitle = tr("Utopiacoin Core") + " - ";
#ifdef ENABLE_WALLET
...
void UtopiacoinGUI::createActions(const NetworkStyle *networkStyle)
{
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About Utopiacoin Core"), this);
    aboutAction->setStatusTip(tr("Show information about Utopiacoin Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for Utopiacoin"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the Utopiacoin Core help message to get a list with possible Utopiacoin command-line options"));
...
void UtopiacoinGUI::setClientModel(ClientModel *clientModel)
{
...
void UtopiacoinGUI::createTrayIcon(const NetworkStyle *networkStyle)
{
    ...
    QString toolTip = tr("Utopiacoin Core client") + " " + networkStyle->getTitleAddText();
...
void UtopiacoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to Utopiacoin network", "", count));
}

void UtopiacoinGUI::setNumBlocks(int count)
{
    if(!clientModel)
        return;
...
#ifdef ENABLE_WALLET
void UtopiacoinGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
void UnitDisplayStatusBarControl::createContextMenu()
{
    ...
    {
        QAction *menuAction = new QAction(QString(UtopiacoinUnits::name(u)), this);
...
{
    setPixmap(QIcon(":/icons/unit_" + UtopiacoinUnits::id(newUnits)).pixmap(31,STATUSBAR_ICONSIZE));
}
