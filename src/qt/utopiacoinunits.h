...
#ifndef UTOPIACOIN_QT_UTOPIACOINUNITS_H
#define UTOPIACOIN_QT_UTOPIACOINUNITS_H
...
/** Utopiacoin unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class UtopiacoinUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit UtopiacoinUnits(QObject *parent);

    /** Utopiacoin units.
      @note Source: https://en.utopiacoin.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        Ucn,
...
typedef UtopiacoinUnits::Unit UtopiacoinUnit;

#endif // UTOPIACOIN_QT_UTOPIACOINUNITS_H
