...
#ifndef UTOPIACOIN_RPCPROTOCOL_H
#define UTOPIACOIN_RPCPROTOCOL_H
...
enum RPCErrorCode
{
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //! Utopiacoin is not connected
...
#endif // UTOPIACOIN_RPCPROTOCOL_H
