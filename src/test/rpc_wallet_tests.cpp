...
BOOST_AUTO_TEST_CASE(rpc_wallet)
{
    ...
    CUtopiacoinAddress demoAddress = CUtopiacoinAddress(CTxDestination(demoPubkey.GetID()));
    Value retValue;
    ...
    CUtopiacoinAddress setaccountDemoAddress = CUtopiacoinAddress(CTxDestination(setaccountDemoPubkey.GetID()));
    ...
    BOOST_CHECK(CUtopiacoinAddress(retValue.get_str()).Get() == demoAddress.Get());
    ...
    BOOST_CHECK(CUtopiacoinAddress(arr[0].get_str()).Get() == demoAddress.Get());
}
