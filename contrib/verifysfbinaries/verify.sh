...
###   This script attempts to download the signature file SHA256SUMS.asc from utopiacoin.org
...
WORKINGDIR="/tmp/utopiacoin"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://utopiacoin.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://utopiacoin.org/bin/"
VERSIONPREFIX="utopiacoin-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'utopiacoin-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[utopiacoin-]<version>-[rc[0-9]] (example: utopiacoin-0.9.2-rc1)"
   echo "wget output:"
