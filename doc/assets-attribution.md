The following is a list of assets used in the utopiacoin source and their proper attribution.
...
* License: MIT
* Site: [https://utopiacointalk.org/index.php?topic=15276.0](https://utopiacointalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original utopiacoin logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/utopiacoin.icns, src/qt/res/src/utopiacoin.svg,
	src/qt/res/src/utopiacoin.ico, src/qt/res/src/utopiacoin.png,
	src/qt/res/src/utopiacoin_testnet.png, docs/utopiacoin_logo_doxygen.png,
