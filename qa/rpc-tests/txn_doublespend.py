...
from test_framework import UtopiacoinTestFramework
...
class TxnMallTest(UtopiacoinTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 1,250 UCN:
        ...
        # First: use raw transaction API to send 1210 UCN to node1_address,
        # but don't broadcast:
        ...
        # Node0's balance should be starting balance, plus 50UCN for another
        ...
        # Node0's total balance should be starting balance, plus 100UCN for 
